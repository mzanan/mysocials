...
Next 16 · React 19 · TypeScript · Tailwind v4 · Turbopack · Framer Motion · Radix · Puppeteer (screenshots Dev) · axios.
...
- Animaciones con `itemVariants` (fade + scale + delay escalonado por `index`).
- Videos lazy hasta `isActive` para evitar descargar todo en cold load.
