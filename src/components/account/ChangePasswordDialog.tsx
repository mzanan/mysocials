  ...
  return (
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed left-1/2 top-1/2 z-50 w-[360px] max-w-[calc(100vw-2rem)] -translate-x-1/2 -translate-y-1/2 rounded-2xl border border-white/[0.12] bg-app-bg/95 p-6 text-white backdrop-blur-2xl shadow-[0_24px_70px_-25px_rgba(0,0,0,0.8)]">
