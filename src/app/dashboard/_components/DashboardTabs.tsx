        ...
        >
          <TabsList className="inline-flex h-auto w-max justify-start gap-1 rounded-xl p-1">
            ...
            <button
              ...
              disabled={pending}
              aria-label="Add tab"
              className="text-fg-subtle hover:bg-surface-strong hover:text-fg ml-1 grid h-8 w-8 flex-none place-items-center rounded-lg transition disabled:opacity-50"
            >
              <Plus size={16} />
            </button>
          </TabsList>
